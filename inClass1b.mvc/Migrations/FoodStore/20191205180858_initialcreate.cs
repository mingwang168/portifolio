    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Building__14E071A090897AF2", x => new { x.building_name, x.unit_num });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Manufact__DF50190D25DA9F9B", x => x.mfg);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Supplier__42A1EB1C33506521", x => x.vendor);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Store__1F84312402E4E266", x => x.branch);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Invoice__F9EE138312C8CEBF", x => x.invoiceNum);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Purchase__0FCD54D59107AFC4", x => x.po_num);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductI__028E307277B32FC7", x => new { x.productID, x.invoiceNum });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductI__028E307229719E68", x => new { x.productID, x.invoiceNum });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductP__6DEC0407062BA8EE", x => new { x.productID, x.po_num });
                    table.ForeignKey(
